...
#this crap is for setting up the usb connections
...
class MultipleCameraSession():
    ...
    def ReadyForTrigger(self, CamNameToPicNum, ListOfCamToBeTriggered):
        ...
        '''
        ### CamNameToPicNum is a dictionary with the number of pictures to be acquired (not true ???)
...
#testing the dogshit code:

#number of pictures to be acquired for each camera, in a single trigger.
CamNameToPicNum = {
        'Cam0' : 0,
        'Cam1' : 0,
        'Cam2' : 1,
