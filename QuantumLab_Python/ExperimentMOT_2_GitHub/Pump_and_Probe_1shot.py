...
#%% FOLDER REFERENCE
folder_path = r'C:\Users\MOT_USER\Documents\Python Scripts\QuantumLabPython\ExperimentMOT_special_2\Output' + '\\' + 'Pump_and_probe_1shot'
...
if TRG_performed == 'y':                    
    ...
    for i in range(0, 1, 1):                   
        ...
        plt.imshow(SubtractImgs(Abs_pump_mx.image,  Bkg_pump_dark_mx.image), cmap='rainbow')
        plt.colorbar() 
        ...
        plt.imshow(SubtractImgs(Abs_probe_mx.image,  Bkg_probe_dark_mx.image), cmap='rainbow')
        plt.tight_layout()
        plt.colorbar() 
        plt.ylabel('row [pixel]')
        plt.xlabel('col [pixel]')
