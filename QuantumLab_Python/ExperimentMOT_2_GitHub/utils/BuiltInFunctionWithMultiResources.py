...
from QuantumLab_Python.ExperimentMOT_2_GitHub.utils.MultiResources import AWGSession, OscilloscopeSession, ResourceManagerCreator
...
DS_AWG1.ApplyDCVoltage(Load ='1000', AWGChannelNum = '2', Volt = '5')
...
# DS_AWG3.ApplyBuiltinWaveform(Load = '1000', AWGChannelNum = '1', FunctionType = 'TRI', Freq = '0.5', Vpp = '8', Offset = '5')
