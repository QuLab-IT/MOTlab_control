...
WaveformList, Headers = CreateArbitraryWaveformVectorFromCSVFile('ProvaCSV.csv', RowNumber = 10)
...
if 'AWG1_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG1.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG1_2' in AWGChannelsToBeUsed:
    ...
    DS_AWG1.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG2_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG2.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
    
if 'AWG2_2' in AWGChannelsToBeUsed:
    FunctionName = Mg.ResourceNameToJob['AWG2_2']
    FunctionVector = SelectWaveform(Headers, WaveformList, FunctionName)
    DS_AWG2.AddArbitraryWaveformToChannelVolatileMemory(FunctionVector, AWGChannelNum = '2', FuncName = FunctionName)
    DS_AWG2.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG3_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG3.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG3_2' in AWGChannelsToBeUsed:
    ...
    DS_AWG3.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG4_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG4.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
    
if 'AWG4_2' in AWGChannelsToBeUsed:
    FunctionName = Mg.ResourceNameToJob['AWG4_2']
    FunctionVector = SelectWaveform(Headers, WaveformList, FunctionName)
    DS_AWG4.AddArbitraryWaveformToChannelVolatileMemory(FunctionVector, AWGChannelNum = '2', FuncName = FunctionName)
    DS_AWG4.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG5_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG5.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG5_2' in AWGChannelsToBeUsed:
    ...
    DS_AWG5.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '5', VLow = '0')
...
try: 
    ...
    if 'Cam0' in ListOfCamerasToBeTriggered:
        ...
        MCS.Set_ROI('Cam0',  CamBinning = 2, PixelWidth = 56, PixelHeight = 56, OffX = 648, OffY = 348) 
    ...
    if 'Cam1' in ListOfCamerasToBeTriggered:
        ...
        MCS.Set_ROI('Cam1', CamBinning = 2, PixelWidth = 72, PixelHeight = 72, OffX = 522, OffY = 280)    
    ...
    if 'Cam2' in ListOfCamerasToBeTriggered:
        ...
        MCS.Set_ROI('Cam2', CamBinning = 2, PixelWidth = 56, PixelHeight = 56, OffX = 598, OffY = 364)
    ...
    for j in range(number_of_experiments):
        for i in ListOfCamerasToBeTriggered:
            for k in range(CamNameToPicNum[i]):
                ...
                img_name_tosave = r'C:\Users\MOT_User\Documents\MOT\QuantumLabPython\ExperimentMOT\Output\exp_pictures' + '\\' + i + '_' + str(j) + '_' + str(k) + '.bmp'
