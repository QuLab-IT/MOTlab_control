...
if ('AWG1_1' or 'AWG1_2') in AWGChannelsToBeUsed: DS_AWG1 = AWGSession(Mg, 'AWG1', 'Captain') ### DS: DeviceSession
if ('AWG2_1' or 'AWG2_2') in AWGChannelsToBeUsed: DS_AWG2 = AWGSession(Mg, 'AWG2')
Mg.WhoIsUp() 
time.sleep(0.5)
...
WaveformList, Headers = CreateArbitraryWaveformVectorFromCSVFile('ProvaCSV.csv', RowNumber = 4)
time.sleep(1)
...
if 'AWG1_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG1.SetBurstOuputArbitraryWaveform('50', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '5', VLow = '0')
...
if 'AWG2_1' in AWGChannelsToBeUsed:
    ...
    DS_AWG2.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '1', SampleRate = '100', VHigh = '2.5', VLow = '0')
...
if 'AWG2_2' in AWGChannelsToBeUsed:
    ...
    DS_AWG2.SetBurstOuputArbitraryWaveform('INF', FuncName = FunctionName, AWGChannelNum = '2', SampleRate = '100', VHigh = '2', VLow = '0')
