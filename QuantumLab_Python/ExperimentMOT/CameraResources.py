...
class MultipleCameraSession():
    ...
    def ReadyForTrigger(self, CamNameToPicNum, ListOfCamToBeTriggered):
        ...
        it is not a parameter of the camera. 'FreeRunMode' do not overlap (?).
        FreeRunMode: set Burst trigger 'On' and Frame trigger 'Off'. 
        ...
        for cam_name in cam_list:
            ...
            cam.AcquisitionBurstFrameCount.SetValue(cam_to_pic[cam_name]) ### In case using Burst trigger.
